...
public class StudentController {
	...
	public String addStudentsDetails(@RequestParam("id") Integer id, @RequestParam("name") String name,
	...
	public String deleteStudentsDetails(@RequestParam("id") Integer id) {
